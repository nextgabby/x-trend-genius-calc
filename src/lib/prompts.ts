...
5. OPPONENT/MATCHUP TERMS — If this is a competition, you MUST include "Team A vs Team B" pairings for confirmed opponents. This is NOT optional when the campaign dates overlap with a known competition. Use your knowledge of tournament draws, fixtures, and schedules to identify the specific opponents. If you are unsure of the exact opponents, state in queryWarnings that you could not confirm the matchups and the user should add them manually. Do NOT silently skip this category.
